          ...
          <table class="table table-bordered">
            ...
            <tbody align="center">
              ...
              <tr style="color:red">
                ...
                <th scope="row"><?= number_format((($sum_20 + $sum_adult) * 3 / 100), 2) ?></th>
                <th scope="row">
                  <span class="badge" style="background-color: red;border-radius:5px;color:#fff">
                    <?= number_format((($sum_15 + $sum_adult)), 2) ?>
                  </span>
                </th>
                <th scope="row"><?= number_format((($sum_15 + $sum_adult) * 2 / 100), 2) ?></th>
                <th scope="row">
                  <span class="badge" style="background-color: red;border-radius:5px;color:#fff">
                ...
                <th scope="row"><?= number_format((($sum_10 + $sum_adult) * 1 / 100), 2) ?></th>
              </tr>
                ...
                <tr>
                  ...
                  <th scope="row">
                    <span class="badge badge-primary">
                      ...
                      $older_children_20 = ((($sum_20 + $sum_adult) * 70) / 100) - $sum_adult;
                  ...
                  <th scope="row">
                    <span class="badge badge-secondary">
                      <?php
                      $older_children_15 = ((($sum_15 + $sum_adult) * 70) / 100) - $sum_adult;
                  ...
                  <th scope="row">
                    <span class="badge badge-success">
                      <?php
                      $older_children_10 = ((($sum_10 + $sum_adult) * 70) / 100) - $sum_adult;
                ...
                <tr style="color: red;">
                  ...
                  <th scope="row">
                    <span class="badge" style="background-color:red;color:#fff;border-radius:5px">
                      <?php $older_20 = $older_children_20 + $sum_adult; ?>
                  ...
                  <th scope="row">
                    <span class="badge" style="background-color:red;color:#fff;border-radius: 5px">
                      <?php $older_15 = $older_children_15 + $sum_adult; ?>
                  ...
                  <th scope="row">
                    <span class="badge" style="background-color:red;color:#fff;border-radius:5px;">
                      ...
                      <?php $older_10 = $older_children_10 + $sum_adult; ?>
              ...
              <table class="table table-bordered">
                ...
                <tbody align="center">
                  ...
                  <tr>
                    ...
                    <th scope="row">
                      <?= number_format((($sum_20 + $sum_adult) * $adult) + (($older_20) * $older_children), 2) ?>
                    </th>
                  </tr>
                  <tr>
                    ...
                    <th scope="row">
                      <?php
                      $a = (($sum_20 + $sum_adult) * $adult) + (($older_20) * $older_children);
              ...
              <table class="table table-bordered">
                ...
                <tbody align="center">
                  ...
                  <tr>
                    ...
                    <th scope="row">
                      <?= number_format((($sum_15 + $sum_adult) * $adult) + (($older_15) * $older_children), 2) ?>

                      <!-- <?= number_format(($sum_15 * $adult) + ($older_children_15 * $older_children) + (($sum_adult * ($_REQUEST['adult']) + ($_REQUEST['older_children'] * $sum))), 2) ?> -->
                  ...
                  <tr>
                    ...
                    <th scope="row">
                      <?php
                      $aa = (($sum_15 + $sum_adult) * $adult) + (($older_15) * $older_children);
              ...
              <table class="table table-bordered">
                ...
                <tbody align="center">
                  ...
                  <tr>
                    <th scope="row">จำนวน ผู้ใหญ่ <?php echo $adult; ?> คน <br>เด็ก อายุ 4-10 ปี <?php echo $older_children; ?> คน <br>เด็ก อายุ 0-3 ปี (ฟรี) <?php echo $child; ?> คน</th>
                    <th scope="row">
                      <?= number_format((($sum_10 + $sum_adult) * $adult) + (($older_10) * $older_children), 2) ?>
                  ...
                  <tr>
                    ...
                    <th scope="row">
                      <?php
                      $aaa = (($sum_15 + $sum_adult) * $adult) + (($older_15) * $older_children);
